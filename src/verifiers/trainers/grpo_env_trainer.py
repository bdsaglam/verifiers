        ...
        if self.log_completions and self.state.global_step % self.args.logging_steps == 0:
            ...
            if self.accelerator.is_main_process:
                ...
                if self.args.report_to and "wandb" in self.args.report_to and wandb.run is not None:  # type: ignore
                    self._log_interactions_to_wandb(
                        inputs_to_log=inputs_to_log,
                        prompts_to_log=prompts_to_log,
                        completions_to_log=completions_to_log,
                        rewards_to_log=rewards_to_log,
