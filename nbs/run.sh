...
dvc exp run --queue \
    -S model.path='outputs/Llama-3.1-8B-Instruct-ragent-20250421_000014-1900' \
    -S model.temperature='0.5' \
    -S model.top_p='0.95' \
...
dvc exp run --queue \
    -S model.path='outputs/Llama-3.1-8B-Instruct-ragent-20250421_000014-1600' \
    -S model.temperature='0.5' \
    -S model.top_p='0.95' \
    -S model.few_shot_prob='0.0' \
    -S retriever.name='hybrid-tei' \
...
dvc exp run --queue \
    -S model.path='outputs/Llama-3.1-8B-Instruct-ragent-20250421_000014-400' \
    -S model.temperature='0.5' \
    -S model.top_p='0.95' \
    -S model.few_shot_prob='0.0' \
    -S retriever.name='hybrid-tei' \
